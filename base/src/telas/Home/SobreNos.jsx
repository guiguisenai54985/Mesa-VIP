...
const SobreNos = () => {
  ...
  return (
    <ScrollView style={estilos.container}>
      ...
      <Image 
        source={{ uri: 'https://img.freepik.com/free-photo/photorealistic-burger-meal_23-2151293080.jpg?t=st=1732628121~exp=1732631721~hmac=ab115a8d9b631284dbde463f094bb59b2b9a3a98fdc00243e77c8d157751cfbe&w=996' }} 
        style={estilos.imagem} 
      />
      
      <Text style={estilos.textoSobreResto}>
        O Restaurante Gourmet oferece uma experiência culinária única em um ambiente acolhedor. Venha nos visitar e descubra sabores incríveis!
      </Text>
